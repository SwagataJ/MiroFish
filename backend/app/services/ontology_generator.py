...
- We need to simulate the reactions of various parties in opinion events and the paths of information propagation
    ...
    "entity_types": [
        {
            ...
            "attributes": [
                {
                    "name": "attr_name (English, snake_case)",
                    "type": "text",
...
A. **Fallback types (required, must be last 2 in the list)**:
   - `Person`: Fallback for any individual natural person. Use when a person does not fit any more specific person type.
   - `Organization`: Fallback for any organization. Use when an organization does not fit any more specific organization type.
...
- The text will contain various people, such as "primary school teacher", "bystander", "some netizen"
- If there is no specific type match, they should fall under `Person`
...
- The description must clearly distinguish this type from the fallback type
