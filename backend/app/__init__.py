...
def create_app(config_class=Config):
    ...
    # JSON encoding: ensure non-ASCII characters display directly (not \uXXXX)
    ...
    # Only print startup info in reloader subprocess (avoid double prints in debug mode)
    ...
    # Initialize i18n (language detection from Accept-Language header)
