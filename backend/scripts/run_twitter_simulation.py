...
This script reads parameters from the config file to run simulations in a fully automated manner
...
# Load .env file from project root directory (contains LLM_API_KEY and other configs)
...
async def main():
    ...
    # Initialize logging configuration (using fixed file names, clean up old logs)
