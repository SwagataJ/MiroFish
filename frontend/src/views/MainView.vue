...
// Step State
const currentStep = ref(1) // 1: Graph Build, 2: Env Setup, 3: Simulation, 4: Report, 5: Deep Interaction
const stepNames = computed(() => [t('mainView.step1'), t('mainView.step2'), t('mainView.step3'), t('mainView.step4'), t('mainView.step5')])
...
const handleNextStep = (params = {}) => {
  if (currentStep.value < 5) {
    ...
    // Log custom rounds when entering Step 3 from Step 2
